...
(() => {
  ...
  function trackerOrbMarkup() {
    ...
    return `
      <div class="orb-content life-tracker-idle">
  ...
  style.textContent = `
    ...
    .life-tracker-idle{width:100%;display:grid;place-items:center;text-align:center}
    .life-tracker-idle .life-tracker-start{display:inline-flex;align-items:center;justify-content:center}
